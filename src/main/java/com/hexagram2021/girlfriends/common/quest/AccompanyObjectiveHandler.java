 ...
 * @author liudongyu
 */
public class AccompanyObjectiveHandler implements QuestObjectiveHandler {
	private static final String PROGRESS_KEY = "accompany";
