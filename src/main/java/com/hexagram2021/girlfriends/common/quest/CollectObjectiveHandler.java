 ...
 * @author liudongyu
 */
public class CollectObjectiveHandler implements QuestObjectiveHandler {
	private static final String PROGRESS_KEY = "collect";
