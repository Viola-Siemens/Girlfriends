 ...
 * @author liudongyu
 */
public class DeliverObjectiveHandler implements QuestObjectiveHandler {
	private static final String PROGRESS_KEY = "deliver";
